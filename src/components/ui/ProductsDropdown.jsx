...
const ProductsDropdown = ({ items, currentPage }) => {
  ...
  return (
    <div className="relative products-dropdown-container nav-links">
      ...
      <div
        className={`absolute overflow-visible top-full mt-2 left-1/2 -translate-x-1/2 lg:w-[900px] md:w-screen w-[450px] bg-white text-slate-500 rounded-md shadow-lg grid lg:grid-cols-5 md:grid-cols-5 grid-cols-3 text-center items-center justify-center transition-all p-2 text-base
                    ${
                      isOpen
