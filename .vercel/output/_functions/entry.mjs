...
import { manifest } from './manifest_DNVqlSOt.mjs';
...
const _page3 = () => import('./pages/es/marca/_marca_.astro.mjs');
const _page4 = () => import('./pages/es/_id_es_.astro.mjs');
const _page5 = () => import('./pages/es.astro.mjs');
const _page6 = () => import('./pages/marca/_marca_.astro.mjs');
...
const pageMap = new Map([
    ...
    ["src/pages/es/marca/[marca].astro", _page3],
    ["src/pages/es/[id_es].astro", _page4],
    ["src/pages/es/index.astro", _page5],
    ["src/pages/marca/[marca].astro", _page6],
...
const _args = {
    "middlewareSecret": "61d36254-0880-4dda-b3e5-e0af39e9f446",
